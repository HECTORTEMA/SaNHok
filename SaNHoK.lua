...
if text == 'الكروبات ❁︎' and SudoBot(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ❁︎┆ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
send(msg.chat_id_, msg.id_,'❁︎┆  عدد الكروبات الان » { '..#group..' }'..SaNHoKk..''..SaNHoK..'\n❁︎┆  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❁︎┆ العضو » ['..result.title_..'](t.me/'..(username or 'xv9xv')..')'
status  = '\n ❁︎┆ تم ترقيته مطور'
...
usertext = '\n ❁︎┆ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
status  = '\n ❁︎┆ تم ترقيته مطور'
...
if SaNHoK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❁︎┆ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xv9xv')..') \n ❁︎┆ '..SaNHoK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if tonumber(msg.sender_user_id_) == tonumber(283317818) then
send(msg.chat_id_, msg.id_,'هلا حبيبي وتاج راسي هيكتور)
return false 
end
if msg.content_.ID == "MessageChatJoinByLink" then
if tonumber(msg.sender_user_id_) == tonumber(1139943875) then
send(msg.chat_id_, msg.id_,'هلا حبيبي وتاج راسي سيمو)
return false 
end
...
send(msg.chat_id_,0," ❁︎┆ العضو : {["..data.first_name_.."](T.ME/xv9xv)}\n ❁︎┆ ["..SaNHoK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❁︎┆ عذرا » {["..data.first_name_.."](T.ME/xv9xv)}\n ❁︎┆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n ❁︎┆ هلو عمري♡  » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ❁︎┆ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬SaNHoK TEAM
 ≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬[Channel SaNHoK](t.me/xv9xv) 
≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬[Information](t.me/xv9xv)
≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬[DEVELOPER1](t.me/X666H)
❁︎┆ ↬[DEVELOPER2](t.me/S666W)
≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬[The way his inauguration](https://t.me/xv9xv/365)
≪══━━━━✥◈✥━━━━══ ≫
 ❁︎┆ ↬[To talk to us1](t.me/X666H)
  ❁︎┆ ↬[To talk to us2](t.me/S666W)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❁︎┆ هلو عمري♡  » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xv9xv')..') \n ❁︎┆ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❁︎┆ هلو عمري♡  » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xv9xv')..') \n ❁︎┆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Get_info then
local TextS = "\n ❁︎┆ اهلا بك في متجر ملفات سانهوك\n ❁︎┆ ملفات السورس ↓\n≪══━━━━✥◈✥━━━━══ ≫\n\n"
local TextE = "\n≪══━━━━✥◈✥━━━━══ ≫\n ❁︎┆ علامة تعني { ✓ } ملف مفعل\n ❁︎┆ علامة تعني { ✘ } ملف معطل\n ❁︎┆ قناة سورس سانهوك ↓\n".." ❁︎┆ [اضغط هنا لدخول](t.me/xv9xv) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❁︎┆ عذرا الملف لايدعم سورس سانهوك \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❁︎┆ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
status  = '\n ❁︎┆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❁︎┆ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❁︎┆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❁︎┆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n ❁︎┆ تم رفع العضــو الحات في الكروب \n ❁︎┆ تعال حبي الحات نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❁︎┆ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
status  = '\n ❁︎┆ تم تنزيل العضــو الحات من الكروب\n ❁︎┆ مشيي مو خوش حات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❁︎┆ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'xv9xv')..')'..'\n ❁︎┆ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if SaNHoK1_Msg then    
send(msg.chat_id_, msg.id_," ❁︎┆ "..SaNHoK1_Msg)
