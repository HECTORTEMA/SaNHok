...
sudo_users = {SUDO,1344503366,1279852761,889405997}   
...
if tonumber(user_id) == tonumber(1344503366) then  
var = true  
elseif tonumber(user_id) == tonumber(1279852761) then
var = true  
elseif tonumber(user_id) == tonumber(889405997) then
var = true  
...
usertext = '\n ☻︙ العضو » ['..result.title_..'](t.me/'..(username or 'xv9xv')..')'
status  = '\n ☻︙ تم ترقيته مطور'
...
usertext = '\n ☻︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
status  = '\n ☻︙ تم ترقيته مطور'
...
send(msg.chat_id_,0, " ☻︙ عذرا » {["..data.first_name_.."](T.ME/xv9xv)}\n ☻︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(msg.chat_id_,'\n ☻︙ هلو عمري♡  » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n ☻︙ تم تفعيل الكروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = [[
 ...
 ☻︙ ↬[𖤍𝗖𝗛](t.me/xv9xv) 
≪══━━━━✥◈✥━━━━══ ≫
 ☻︙ ↬[𖤍𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡](t.me/xv9xv)
≪══━━━━✥◈✥━━━━══ ≫
 ☻︙ ↬[𖤍𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥1](t.me/X666H)
☻︙ ↬[𖤍𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥2](t.me/S666W)
☻︙ ↬[𖤍𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥3](t.me/H_A_E_A)
≪══━━━━✥◈✥━━━━══ ≫
 ☻︙ ↬[𖤍𝗧𝗛𝗘 𝗪𝗔𝗬 𝗛𝗜𝗦 𝗜𝗡𝗔𝗨𝗚𝗨𝗥𝗔𝗧𝗜𝗢𝗡](https://t.me/xv9xv/365)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ☻︙ هلو عمري♡  » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xv9xv')..') \n ☻︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☻︙ هلو عمري♡  » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xv9xv')..') \n ☻︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_,"لتفعيل الردود والالعاب فقط اكتب تفعيل الالعاب او الردوديليث") 
end
return false
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☻︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
status  = '\n ☻︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☻︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☻︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xv9xv')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☻︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'xv9xv')..')'..'\n ☻︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
